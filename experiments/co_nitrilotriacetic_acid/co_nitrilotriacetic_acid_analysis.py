#!/usr/bin/env python3
"""
Complete Metal-Ligand Binding Analysis Example: Co(II)-Nitrilotriacetic Acid Complex
...
def analyze_co_nitrilotriacetic_acid_complex():
    """
    Analyze Co(II)-Nitrilotriacetic Acid complex formation and binding.
    ...
    config = ComplexConfig(
        # Experiment settings
        experiment_name="co_nitrilotriacetic_acid_binding_analysis",
...
def main():
    ...
    try:
        analyze_co_nitrilotriacetic_acid_complex()
    except Exception as e:
