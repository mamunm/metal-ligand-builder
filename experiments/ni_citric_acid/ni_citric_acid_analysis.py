#!/usr/bin/env python3
"""
Complete Metal-Ligand Binding Analysis Example: Ni(II)-Citric Acid Complex
...
Citric acid is a tricarboxylic acid that can coordinate through carboxyl groups
with metal ions.
"""
...
def analyze_ni_citric_acid_complex():
    """
    Analyze Ni(II)-Citric Acid complex formation and binding.
    
    Citric acid can coordinate through:
    ...
    config = ComplexConfig(
        # Experiment settings
        experiment_name="ni_citric_acid_binding_analysis",
    ...
    # Citric acid SMILES
    citric_acid_smiles = "C(C(=O)O)C(CC(=O)O)(C(=O)O)O"
    
    complex = MetalLigandComplex(
        ligand_name="citric_acid",
        ligand_smiles=citric_acid_smiles,
        metal_symbol="Ni",
        metal_charge=2,      # Ni²⁺
        ligand_charge=0,     # Citric acid neutral form for structure generation
...
def main():
    ...
    try:
        analyze_ni_citric_acid_complex()
    except Exception as e:
