#!/usr/bin/env python3
"""
Complete Metal-Ligand Binding Analysis Example: Ni(II)-EDTA Complex
...
def analyze_ni_edta_complex():
    """
    Analyze Ni(II)-EDTA complex formation and binding.
    ...
    config = ComplexConfig(
        # Experiment settings
        experiment_name="ni_edta_binding_analysis",
